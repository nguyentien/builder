var
  ...
  dom_api = {
    ...
    builder: [
         ...
         * <code>
         *
         * $('iframe').coffeeBuilder('addBreakpoint', {
         *   panels: {
         *     page: {
         *       name: "Page",
         *       customizations: {
         ...
         * <code>
         *
         * $('iframe').coffeeBuilder('activateBreakpoint', 'default');
         *
         * </code>
         *
      ...
      , 'activateBreakpoint'
         ...
         * <code>
         *
         * $('iframe').coffeeBuilder('moveBreakpoint', '320', '500');
         *
         * </code>
         *
      ...
      , 'moveBreakpoint'
         ...
         * <code>
         *
         * $('iframe').coffeeBuilder('removeBreakpoint', '320');
         *
         * </code>
         *
         * @param   String name  A unique key to identify the breakpoint ('default' or a natural number > 0)
...
$.fn.coffeeBuilder = function(option){
  ...
  breakpoint = data.getCurrentBreakpoint();
  if(typeof option === 'string') {

    // Data APIs
    if($.inArray(option, data_api.builder) !== -1) {
      return data[option].apply(data, args);
    } else if($.inArray(option, data_api.breakpoints) !== -1) {
      return breakpoint[option].apply(breakpoint, args);
    }

    // DOM APIs
    if($.inArray(option, dom_api.builder) !== -1) {
      data[option].apply(data, args);
    } else if($.inArray(option, dom_api.breakpoints) !== -1) {
      breakpoint[option].apply(breakpoint, args);
